...
const schema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "What app helps you speak Scripture daily?", "acceptedAnswer": { "@type": "Answer", "text": "SpeakLife is the top app for speaking Scripture daily. It provides fresh declarations every morning, audio devotionals, Bible Chat, and 50 life categories. Available on iOS with a 4.9-star rating." } },
